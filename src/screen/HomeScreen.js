...
const HomeScreen = ({ navigation }) => {
  ...
  // const checkIsAccountLinked = async () => {
  //   const user = auth().currentUser;
  //   console.log("*************** Sign-in provider: user **************" + user.providerData);
  //    let googleProvider;
  ...
  //       if (profile.providerId.toLocaleLowerCase === "google.com") {
  //         googleProvider = profile.providerId
  //       } else if (profile.providerId.toLocaleLowerCase === "firebase") {
  //         firebaseProvider = profile.providerId
  //       }
  //       console.log("*************** Sign-in provider: **************" + profile.providerId);
  //       console.log(" *************** Provider-specific UID: *************** " + profile.uid);
  ...
  //      console.log("*************** Sign-in provider  googleProvider : **************" + googleProvider);
  //     console.log("*************** Sign-in provider  firebaseProvider : **************" + firebaseProvider);


  //     if ( googleProvider && firebaseProvider) {
  //       return true
  //     } else {
  //       return false
  //     }
  ...
  //   //   // Check if the user is already linked with the current sign-in method
  //   //   const linkedAccountsSnapshot = await firestore()
  //   //     .collection('users')
  //   //     .doc(currentUser.uid)
  //   //     .collection('linkedAccounts')
  //   //     .doc('providers') // or use a unique identifier for the linked account
  //   //     .get();
  
  //   //   const linkedAccounts = linkedAccountsSnapshot.data();
  
  //   //   // Check if the current sign-in method is already linked
  //   //   const isLinked = linkedAccounts && linkedAccounts['yourSignInProvider'];
